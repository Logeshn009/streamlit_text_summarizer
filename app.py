...
def run_model(input_text):
    ...
    if model == "BART":
        ...
        data_bart = {"model": model, "parameters": {"_num_beams": _num_beams,  "_no_repeat_ngram_size": _no_repeat_ngram_size,
                                                    "_length_penalty": _length_penalty, "_min_length": _min_length, "_max_length": _max_length, "_early_stopping": _early_stopping},
                     "summarized_text": {"input_text": text, "summarized_text": output}}
        ...
        output = [t5_tokenizer.decode(g, skip_special_tokens=True, clean_up_tokenization_spaces=False) for g in
                  summary_ids]
        data_t5 = {"model": "T5", "parameters": {"_num_beams": _num_beams,  "_no_repeat_ngram_size": _no_repeat_ngram_size,
                                                 "_length_penalty": _length_penalty, "_min_length": _min_length, "_max_length": _max_length, "_early_stopping": _early_stopping},
                   "summarized_text": {"input_text": text, "summarized_text": output}}
